...
6. **結果保存**: `report/test-results.md` に検証結果を保存
...
検証完了後、必ず以下の形式で `report/test-results.md` ファイルを作成して結果を保存してください：
...
**重要**: 検証完了後、必ず `report/test-results.md` ファイルを作成して結果を保存し、gitコミットしてください。
