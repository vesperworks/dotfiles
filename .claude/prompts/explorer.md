...
6. **結果保存**: `report/explore-results.md` に調査結果を保存
...
調査完了後、必ず以下の形式で `report/explore-results.md` ファイルを作成して結果を保存してください：
...
**重要**: 調査完了後、必ず `report/explore-results.md` ファイルを作成して結果を保存し、gitコミットしてください。
