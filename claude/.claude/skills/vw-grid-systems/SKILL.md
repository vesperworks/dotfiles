...
description: "Build editorial, magazine, report, app, or book-style webpages on one of 9 rigorously defined grid systems — from Müller-Brockmann's modular grid to Bootstrap, Material Design, Golden Ratio, and Classical Canons of page construction. Each system ships with precise CSS variables, scaffold CSS, typography rules, and palette defaults. Triggers: grid system, editorial layout, Swiss design, magazine spread, bootstrap grid, material design grid, golden ratio layout, 8-point grid, book layout, Vignelli, Gerstner, Tschichold. NOT for non-layout tasks."
---
...
<!--
  ...
  Other systems researched and compiled for Claude Code SKILL format.
-->
